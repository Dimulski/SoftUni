...
CREATE DATABASE IF NOT EXISTS `car_dealer` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `car_dealer`;
...
INSERT INTO `cars` (`id`, `make`, `model`, `travelled_distance`) VALUES
	...
	(50, 'Fiat', 'Panda 4x4', 9.22337368547758e16),
	...
	(72, 'Mercedes', 'W210', 9.223372036854776e18),
	...
	(210, 'Chevy', 'Cruze', 9.223372034775808e15),
	(211, 'Chevy', 'Caprice', 9.223372034775808e15),
	...
	(227, 'Lamborghini', 'Gallardo', 9.223372054775808e15),
	...
	(305, 'Citroen', 'C3', 9.223336854775808e15),
	...
	(335, 'Skoda', 'Fabia', 9.223372036875808e15),
...
-- Dumping structure for table car_dealer.customers
CREATE TABLE IF NOT EXISTS `customers` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `birth_date` datetime DEFAULT NULL,
  `young_driver` bit(1) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8;

-- Dumping data for table car_dealer.customers: ~30 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`id`, `birth_date`, `young_driver`, `name`) VALUES
	(1, '1993-11-20 00:00:00', b'1', 'Emmitt Benally'),
	(2, '1990-10-04 00:00:00', b'0', 'Natalie Poli'),
	(3, '1990-10-04 00:00:00', b'1', 'Marcelle Griego'),
	(4, '1982-10-01 00:00:00', b'1', 'Zada Attwood'),
	(5, '1985-10-01 00:00:00', b'1', 'Hai Everton'),
	(6, '1985-12-21 00:00:00', b'0', 'Lino Subia'),
	(7, '1984-10-01 00:00:00', b'1', 'Rico Peer'),
	(8, '1975-10-01 00:00:00', b'1', 'Teddy Hobby'),
	(9, '1995-10-01 00:00:00', b'1', 'Johnette Derryberry'),
	(10, '1976-10-01 00:00:00', b'0', 'Audrea Cardinal'),
	(11, '1977-10-01 00:00:00', b'1', 'Francis Mckim'),
	(12, '1987-10-01 00:00:00', b'0', 'Carole Witman'),
	(13, '1988-10-01 00:00:00', b'1', 'Oren Perlman'),
	(14, '1980-10-01 00:00:00', b'1', 'Brett Brickley'),
	(15, '1981-10-03 00:00:00', b'0', 'Kristian Engberg'),
	(16, '1972-02-02 00:00:00', b'1', 'Carri Knapik'),
	(17, '1970-05-01 00:00:00', b'1', 'Rema Revelle'),
	(18, '1994-10-01 00:00:00', b'0', 'Taina Achenbach'),
	(19, '1992-03-02 00:00:00', b'1', 'Yvonne Mccalla'),
	(20, '1994-04-04 00:00:00', b'0', 'Nisha Markwell'),
	(21, '1992-11-01 00:00:00', b'1', 'Cinthia Lasala'),
	(22, '1995-10-05 00:00:00', b'0', 'Daniele Zarate'),
	(23, '1994-06-01 00:00:00', b'0', 'Faustina Burgher'),
	(24, '1986-07-01 00:00:00', b'1', 'Jimmy Grossi'),
	(25, '1983-10-01 00:00:00', b'0', 'Sylvie Mcelravy'),
	(26, '1982-08-01 00:00:00', b'1', 'Hipolito Lamoreaux'),
	(27, '1975-07-01 00:00:00', b'0', 'Garret Capron'),
	(28, '1963-10-01 00:00:00', b'1', 'Donnetta Soliz'),
	(29, '1960-10-01 00:00:00', b'0', 'Louann Holzworth'),
	(30, '1992-03-02 00:00:00', b'1', 'Ann Mcenaney');
/*!40000 ALTER TABLE `customers` ENABLE KEYS */;

-- Dumping structure for table car_dealer.logs
...
-- Dumping data for table car_dealer.logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;

-- Dumping structure for table car_dealer.parts
...
-- Dumping data for table car_dealer.parts: ~0 rows (approximately)
...
-- Dumping structure for table car_dealer.parts_cars
...
-- Dumping data for table car_dealer.parts_cars: ~0 rows (approximately)
...
-- Dumping structure for table car_dealer.sales
CREATE TABLE IF NOT EXISTS `sales` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `discount` float(2,2) DEFAULT NULL,
...
-- Dumping data for table car_dealer.sales: ~50 rows (approximately)
...
-- Dumping structure for table car_dealer.suppliers
CREATE TABLE IF NOT EXISTS `suppliers` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `importer` bit(1) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8;

-- Dumping data for table car_dealer.suppliers: ~31 rows (approximately)
/*!40000 ALTER TABLE `suppliers` DISABLE KEYS */;
INSERT INTO `suppliers` (`id`, `importer`, `name`) VALUES
	(1, b'1', '3M Company'),
	(2, b'0', 'Agway Inc.'),
	(3, b'1', 'Anthem, Inc.'),
	(4, b'0', 'Airgas, Inc.'),
	(5, b'1', 'Atmel Corporation'),
	(6, b'1', 'Big Lots, Inc.'),
	(7, b'0', 'Caterpillar Inc.'),
	(8, b'1', 'Casey\'s General Stores Inc.'),
	(9, b'0', 'Cintas Corp.'),
	(10, b'1', 'Chubb Corp'),
	(11, b'0', 'Cintas Corp.'),
	(12, b'1', 'CNF Inc.'),
	(13, b'1', 'CMGI Inc.'),
	(14, b'0', 'The Clorox Co.'),
	(15, b'1', 'Danaher Corporation'),
	(16, b'0', 'E.I. Du Pont de Nemours and Company'),
	(17, b'1', 'E*Trade Group, Inc.'),
	(18, b'1', 'Emcor Group Inc.'),
	(19, b'0', 'GenCorp Inc.'),
	(20, b'1', 'IDT Corporation'),
	(21, b'0', 'Level 3 Communications Inc.'),
	(22, b'1', 'Merck & Co., Inc.'),
	(23, b'0', 'Nicor Inc'),
	(24, b'1', 'Olin Corp.'),
	(25, b'1', 'Paychex Inc'),
...
-- Dumping data for table car_dealer.users: ~0 rows (approximately)
