...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `is_young_driver` bit(1) DEFAULT NULL,
...
INSERT INTO `customers` (`id`, `birth_date`, `is_young_driver`, `name`) VALUES
...
CREATE TABLE IF NOT EXISTS `parts` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK1vrgi5phdjjjf9j3vl1cylmx4` (`supplier_id`),
  CONSTRAINT `FK1vrgi5phdjjjf9j3vl1cylmx4` FOREIGN KEY (`supplier_id`) REFERENCES `part_suppliers` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8;

-- Dumping data for table car_dealer.parts: ~131 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `parts_cars` (
  ...
  KEY `FK9bkl7o8lnx1ykan7pqk0ww0ar` (`car_id`),
...
-- Dumping data for table car_dealer.parts_cars: ~1,170 rows (approximately)
...
-- Dumping structure for table car_dealer.part_suppliers
...
-- Dumping data for table car_dealer.part_suppliers: ~31 rows (approximately)
/*!40000 ALTER TABLE `part_suppliers` DISABLE KEYS */;
INSERT INTO `part_suppliers` (`id`, `is_importer`, `name`) VALUES
	(1, b'1', '3M Company'),
	(2, b'0', 'Agway Inc.'),
	(3, b'1', 'Anthem, Inc.'),
	(4, b'0', 'Airgas, Inc.'),
