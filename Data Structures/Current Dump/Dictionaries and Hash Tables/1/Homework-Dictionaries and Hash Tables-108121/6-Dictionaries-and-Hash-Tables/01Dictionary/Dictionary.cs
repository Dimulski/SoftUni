namespace _01Dictionary
{
    ...
    public class Dictionary<TKey, TValue> : IEnumerable<KeyValue<TKey, TValue>>
    {
        ...
        public Dictionary(int capacity = InitCapacity)
        {
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            foreach (var element in this.slots[slotNumber])
            {
                ...
                {
                    throw new AggregateException("Key already exists: " + key);
                }
            }
        ...
        public TValue Get(TKey key)
        {
            ...
            if (element == null)
            {
                throw new KeyNotFoundException("Key dose not exists: " + key);
            }
        ...
        private void GrowIfNeeded()
        {
            ...
            {
                var newElements = new Dictionary<TKey, TValue>(this.Capacity * 2);
                foreach (var element in this)
                {
                    newElements.Add(element.Key, element.Value);
                }
                this.slots = newElements.slots;
                this.Count = newElements.Count;
            }
        }
